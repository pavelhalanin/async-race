(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e={limitCars:7,limitWinners:10},t={async engineStart(e){let t=`http://localhost:3000/engine/?id=${e}&status=started`,n=await fetch(t,{method:`PATCH`}),r=n.status;if(r!==200)throw Error(`HTTP ${r}`);return await n.json()},async engineDrive(e){let t=`http://localhost:3000/engine/?id=${e}&status=drive`,n=await fetch(t,{method:`PATCH`}),r=n.status;if(r!==200)throw Error(`HTTP ${r}`);return await n.json()},async engineStopped(e){let t=`http://localhost:3000/engine/?id=${e}&status=stopped`,n=await fetch(t,{method:`PATCH`}),r=n.status;if(r!==200)throw Error(`HTTP ${r}`);return await n.json()}},n={getLastPage(e,t){return Math.ceil(e/t)}},r=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><!--!Font Awesome Free 7.3.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2026 Fonticons, Inc.--><path d="M147 170.7L117.2 256L240.1 256L240.1 160L162.2 160C155.4 160 149.3 164.3 147.1 170.7zM48.6 257.9L86.5 149.6C97.8 117.5 128.1 96 162.1 96L360 96C385.2 96 408.9 107.9 424 128L520.2 256.3C587.1 260.5 640 316.1 640 384L640 400C640 435.3 611.3 464 576 464L559.6 464C555.6 508.9 517.9 544 472 544C426.1 544 388.4 508.9 384.4 464L239.7 464C235.7 508.9 198 544 152.1 544C106.2 544 68.5 508.9 64.5 464L64.1 464C28.8 464 .1 435.3 .1 400L.1 320C.1 289.9 20.8 264.7 48.7 257.9zM440 256L372.8 166.4C369.8 162.4 365 160 360 160L288 160L288 256L440 256zM152 496C174.1 496 192 478.1 192 456C192 433.9 174.1 416 152 416C129.9 416 112 433.9 112 456C112 478.1 129.9 496 152 496zM512 456C512 433.9 494.1 416 472 416C449.9 416 432 433.9 432 456C432 478.1 449.9 496 472 496C494.1 496 512 478.1 512 456z"/></svg>`,i=`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-exclamation-triangle" viewBox="0 0 16 16">
  ...
  <path d="M7.002 12a1 1 0 1 1 2 0 1 1 0 0 1-2 0M7.1 5.995a.905.905 0 1 1 1.8 0l-.35 3.507a.552.552 0 0 1-1.1 0z"/>
    ...
    `,document.querySelector(`#pagination_prev_button`)?.addEventListener(`click`,async()=>await _.render(t-1,e.limitCars)),document.querySelector(`#pagination_next_button`)?.addEventListener(`click`,async()=>await _.render(t+1,e.limitCars)),document.querySelector(`#pagination_select`)?.addEventListener(`change`,async t=>{let n=t.target;if(n instanceof HTMLSelectElement){let t=parseInt(n.value);await _.render(t,e.limitCars)}})}},s={paginationTypeSort:Object.freeze({noSort:0,idAsc:1,idDesc:2,winsAsc:3,winsDesc:4,timeAsc:5,timeDesc:6}),async getPagination(e,t,n=0){let r=`http://localhost:3000/winners/?_page=${e}&_limit=${t}`,i={[s.paginationTypeSort.idAsc]:{sort:`id`,order:`ASC`},[s.paginationTypeSort.idDesc]:{sort:`id`,order:`DESC`},[s.paginationTypeSort.winsAsc]:{sort:`wins`,order:`ASC`},[s.paginationTypeSort.winsDesc]:{sort:`wins`,order:`DESC`},[s.paginationTypeSort.timeAsc]:{sort:`time`,order:`ASC`},[s.paginationTypeSort.timeDesc]:{sort:`time`,order:`DESC`}}[n];i&&(r+=`&_sort=${i.sort}&_order=${i.order}`);let a=await fetch(r),o=a.status;if(o!==200)throw Error(`HTTP ${o}`);return{WINNERS:await a.json(),TOTAL_COUNT:Number(a.headers.get(`x-total-count`))}},async getById(e){let t=`http://localhost:3000/winners/${e}`,n=await fetch(t),r=n.status;if(r!==200)throw Error(`HTTP ${r}`);return await n.json()},async create(e){let t=await fetch(`http://localhost:3000/garage/`,{method:`POST`,body:JSON.stringify(e),headers:{"Content-Type":`application/json`}}),n=t.status;if(n!==201)throw Error(`HTTP ${n}`);return await t.json()},async remove(e){let t=`http://localhost:3000/winners/${e}`,n=(await fetch(t,{method:`DELETE`})).status;if(n!==200)throw Error(`HTTP ${n}`)},async update(e,t){let n=`http://localhost:3000/garage/${t}`,r=await fetch(n,{method:`PUT`,body:JSON.stringify(e),headers:{"Content-Type":`application/json`}}),i=r.status;if(i!==200)throw Error(`HTTP ${i}`);return await r.json()}},c={idForm:`create_car_form`,render(e){return`
      <button
    ...
    `},init(e){let t=`button[data-car-id="${CSS.escape(String(e))}"]`,n=document.querySelector(t);if(!n){console.error(`Node not found: ${t}`);return}n.addEventListener(`click`,c.onClick)},async onClick(t){let n=t.target;if(!(n instanceof HTMLButtonElement))return;let r=Number(n.dataset.carId)||0;console.log(`Remove car with ID: ${r}`),await h.remove(r),await s.remove(r),await _.render(d.getPage(),e.limitCars)}},l={idForm:`update_car_form`,localStorageKey:`async_race__car_update_data`,idNameInput:`update_car__name_input`,idColorInput:`update_car__color_input`,render(){let e=l.getUpdateData();return`
      <form id="${l.idForm}">
        <label
          for="${l.idNameInput}"
        >
    ...
    `},init(){let e=document.querySelector(`#${g.idForm}`);if(!e){console.error(`Node not found: #${g.idForm}`);return}e.addEventListener(`submit`,g.onSubmit);let t=document.querySelector(`#${g.idNameInput}`);if(!t){console.error(`Node not found: #${g.idNameInput}`);return}t.addEventListener(`input`,function(){g.setName(this.value)});let n=document.querySelector(`#${g.idColorInput}`);if(!n){console.error(`Node not found: #${g.idColorInput}`);return}n.addEventListener(`input`,function(){g.setColor(this.value)})},async onSubmit(t){t.preventDefault();let n=t.target;if(!(n instanceof HTMLFormElement))return;let r=new FormData(n),i={name:r.get(`name`)?.toString()||`Unnamed car`,color:r.get(`color`)?.toString()||`#000000`};console.log(`Try to create car`,i);let a=await h.create(i);console.log(`Created car`,a),await _.render(d.getPage(),e.limitCars)},getCreateData(){let e=localStorage.getItem(g.localStorageKey),t={name:``,color:``};if(e)try{let n=JSON.parse(e);typeof n==`object`&&n&&`name`in n&&typeof n.name==`string`&&(t.name=n.name),typeof n==`object`&&n&&`color`in n&&typeof n.color==`string`&&(t.color=n.color)}catch(e){console.error(e)}return localStorage.setItem(g.localStorageKey,JSON.stringify(t)),t},setName(e){let t=g.getCreateData();t.name=e,localStorage.setItem(g.localStorageKey,JSON.stringify(t))},setColor(e){let t=g.getCreateData();t.color=e,localStorage.setItem(g.localStorageKey,JSON.stringify(t))}},_={async render(e,t){let n=`#${x.idContent}`,r=document.querySelector(n);if(!r){console.log(`Node is not found: ${n}`);return}try{r.innerHTML=`
        ...
        <div id="${o.idPaginationContainer}"></div>
      `,await d.render(e,t)}catch(e){r.innerHTML=`
        <div>${e}</div>
      `}}},v={idContainer:`winners_pagination`,async render(t,r,i){let a=`#${v.idContainer}`,o=document.querySelector(a);if(!o){console.error(`Node is not found: ${a}`);return}o.innerHTML=`Loading...`;let s=n.getLastPage(i,r);o.innerHTML=`
      <button class="btn btn-primary" id="pagination_prev_button" ${t<=1?`disabled`:``}>Prev</button>
      <select id="pagination_select" class="btn">
        ...
        <thead>
          <tr>
            <th width="120" class="winners__th">
              Number
              ${y.getSortButton(0,n,s.paginationTypeSort.idDesc,`winners_sort_id_desc_button`)}
              ${y.getSortButton(1,n,s.paginationTypeSort.idAsc,`winners_sort_id_asc_button`)}
            </th>
            <th width="70">Car</th>
            <th>Name</th>
            <th width="100" class="winners__th">
              Wins
              ${y.getSortButton(0,n,s.paginationTypeSort.winsDesc,`winners_sort_wins_desc_button`)}
              ${y.getSortButton(1,n,s.paginationTypeSort.winsAsc,`winners_sort_wins_asc_button`)}
            </th>
            <th width="200" class="winners__th">
              Best time (seconds)
              ${y.getSortButton(0,n,s.paginationTypeSort.timeDesc,`winners_sort_time_desc_button`)}
              ${y.getSortButton(1,n,s.paginationTypeSort.timeAsc,`winners_sort_time_asc_button`)}
            </th>
          </tr>
        </thead>
        ${await y.renderTbody(a)}
      </table>
    `,await y.componentDidMount(e,t,o,n)},getSortButton(e,t,n,r){return`
      <button
      ...
      <tbody>
        ${(await Promise.all(e.map(async e=>{try{let t=await h.getById(e.id);return`
            <tr>
              ...
              <td align="center">${a.render(t.color)}</td>
              <td>${t.name}</td>
    ...
    `},getPage(){return Number(localStorage.getItem(y.localStoragePage)||1)||1},savePage(e){localStorage.setItem(y.localStoragePage,String(e))},fixPage(e,t,r,i){let a=n.getLastPage(r,t);e>a&&(y.savePage(a),y.render(a,t,i))},async componentDidMount(e,t,n,r){await v.render(e,t,n),y.fixPage(e,t,n,r),document.querySelector(`#winners_sort_id_asc_button`)?.addEventListener(`click`,()=>b.render(e,t,s.paginationTypeSort.idAsc)),document.querySelector(`#winners_sort_id_desc_button`)?.addEventListener(`click`,()=>b.render(e,t,s.paginationTypeSort.idDesc)),document.querySelector(`#winners_sort_wins_asc_button`)?.addEventListener(`click`,()=>b.render(e,t,s.paginationTypeSort.winsAsc)),document.querySelector(`#winners_sort_wins_desc_button`)?.addEventListener(`click`,()=>b.render(e,t,s.paginationTypeSort.winsDesc)),document.querySelector(`#winners_sort_time_asc_button`)?.addEventListener(`click`,()=>b.render(e,t,s.paginationTypeSort.timeAsc)),document.querySelector(`#winners_sort_time_desc_button`)?.addEventListener(`click`,()=>b.render(e,t,s.paginationTypeSort.timeDesc))}},b={async render(e,t,n=0){let r=`#${x.idContent}`,i=document.querySelector(r);if(!i){console.log(`Node is not found: ${r}`);return}try{i.innerHTML=`
