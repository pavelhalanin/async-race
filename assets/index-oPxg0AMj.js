(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),t.credentials=e.crossOrigin===`use-credentials`?`include`:e.crossOrigin===`anonymous`?`omit`:`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e={limit:7},t={getRandomColor(){let e=`#`;for(let t=0;t<6;t++)e+=`0123456789ABCDEF`[Math.floor(Math.random()*16)];return e}},n={random_from_a_to_b(e,t){return Math.ceil(Math.random()*(t-e)+e)}},r={Tesla:[`Cyber`,`Ludicrous`,`Plaid`,`Space`,`Nova`,`Photon`,`Volt`,`Neon`,`Apex`,`Nexus`],BMW:[`M Sport`,`Dynamic`,`Elite`,`Vantage`,`X Drive`,`Pure`,`Sprint`,`Turbo`,`Premium`,`Evolution`],Mersedes:[`AMG`,`Elite`,`V8`,`Kompressor`,`Avantgarde`,`Sport`,`Luxury`,`Estate`,`Coupe`,`Sprint`],Ford:[`Raptor`,`SVT`,`Cobra`,`Boss`,`King`,`Titan`,`Wild`,`Maverick`,`Outlaw`,`Safari`],Audi:[`Quattro`,`S Line`,`RS`,`e-tron`,`Vorsprung`,`Sport`,`Elite`,`Progress`,`Advance`,`Motion`],Toyota:[`TRD`,`Hybrid`,`Supra`,`Off-Road`,`Sport`,`Luxury`,`Adventure`,`Touring`,`GR`,`Apex`],Honda:[`Type R`,`Sport`,`Touring`,`Hybrid`,`Performance`,`Elite`,`Si`,`Adventure`,`S-Tech`,`V-TEC`],Nissan:[`GT-R`,`Nismo`,`Sport`,`Elite`,`Pro-4X`,`Titan`,`Z`,`Skyline`,`Adventure`,`Performance`],Chevrolet:[`SS`,`ZR1`,`Z06`,`RST`,`LTZ`,`Sport`,`Performance`,`Trail`,`High Country`,`Bolt`],Volkswagen:[`R-Line`,`GTI`,`TDI`,`Sport`,`4Motion`,`Comfort`,`Sprint`,`Elite`,`Atlas`,`Taos`],Porsche:[`Turbo`,`S`,`GTS`,`RS`,`Targa`,`Carrera`,`Cayman`,`Boxster`,`Panamera`,`Taycan`],Ferrari:[`Scuderia`,`Spider`,`GTB`,`GTS`,`Special`,`Stradale`,`Pista`,`Assetto`,`Competizione`,`Challenge`],Lamborghini:[`SV`,`Spyder`,`Performante`,`Superleggera`,`Edizione`,`Nero`,`Giallo`,`Verde`,`Arancio`,`Bianco`],Maserati:[`GranSport`,`GranTurismo`,`S`,`Trofeo`,`Ghibli`,`Levante`,`MC`,`Racing`,`Sport`,`Luxury`],Bugatti:[`SuperSport`,`Pur Sport`,`Vitesse`,`Grand Sport`,`Sang Noir`,`Rembrandt`,`L'Or Blanc`,`La Voiture Noire`,`Centodieci`,`Divo`],"Aston Martin":[`Vantage`,`Vanquish`,`Rapide`,`DBS`,`Valkyrie`,`Valhalla`,`DB11`,`Volante`,`Q`,`Shadow`],Jaguar:[`SVR`,`R-Dynamic`,`Sport`,`Luxury`,`Performance`,`Black`,`Elegance`,`Portfolio`,`XKR`,`Supercharged`],"Land Rover":[`Autobiography`,`Sport`,`HSE`,`Vogue`,`SV`,`AWD`,`Adventure`,`Premium`,`Evoque`,`Defender`],Volvo:[`R-Design`,`Inscription`,`T8`,`Momentum`,`Polestar`,`Excellence`,`Ocean`,`Fusion`,`Thunder`,`Aurora`],Subaru:[`STI`,`WRX`,`Sport`,`Touring`,`Wilderness`,`XT`,`Premium`,`Limited`,`GT`,`Adventure`]},i={async getPagination(e,t){let n=`http://localhost:3000/garage/?_page=${e}&_limit=${t}`,r=await fetch(n),i=r.status;if(i!==200)throw Error(`HTTP ${i}`);return{CARS:await r.json(),TOTAL_COUNT:Number(r.headers.get(`x-total-count`))}},async getById(e){let t=`http://localhost:3000/garage/${e}`,n=await fetch(t),r=n.status;if(r!==200)throw Error(`HTTP ${r}`);return await n.json()},async create(e){let t=await fetch(`http://localhost:3000/garage/`,{method:`POST`,body:JSON.stringify(e),headers:{"Content-Type":`application/json`}}),n=t.status;if(n!==201)throw Error(`HTTP ${n}`);return await t.json()},async remove(e){let t=`http://localhost:3000/garage/${e}`,n=(await fetch(t,{method:`DELETE`})).status;if(n!==200)throw Error(`HTTP ${n}`)},async update(e,t){let n=`http://localhost:3000/garage/${t}`,r=await fetch(n,{method:`PUT`,body:JSON.stringify(e),headers:{"Content-Type":`application/json`}}),i=r.status;if(i!==200)throw Error(`HTTP ${i}`);return await r.json()},async generageRandom100Cars(){this.setAttribute(`disabled`,`true`),this.innerHTML=`Generate cars (loading...)`;let a=r,o=Object.keys(a);for(let e=1;e<=100;e++){let e=o[n.random_from_a_to_b(0,o.length-1)],r=a[e],s={name:`${e}-${r[n.random_from_a_to_b(0,r.length-1)]}`,color:t.getRandomColor()};await i.create(s)}await m.render(1,e.limit),this.removeAttribute(`disabled`),this.innerHTML=`Generate cars`}},a={idForm:`create_car_form`,render(){return`
    ...
    `,document.querySelector(`#pagination_prev_button`)?.addEventListener(`click`,async()=>await m.render(t-1,e.limit)),document.querySelector(`#pagination_next_button`)?.addEventListener(`click`,async()=>await m.render(t+1,e.limit)),document.querySelector(`#pagination_select`)?.addEventListener(`change`,async t=>{let n=t.target;if(n){let t=parseInt(n.value);await m.render(t,e.limit)}})}},u={idForm:`create_car_form`,render(e){return`
      <button class="btn btn-danger" data-car-id="${e}">Remove</button>
    `},init(e){let t=`button[data-car-id="${CSS.escape(String(e))}"]`,n=document.querySelector(t);if(!n){console.error(`Node not found: ${t}`);return}n.addEventListener(`click`,u.onClick)},async onClick(t){let n=t.target,r=Number(n.dataset.carId)||0;console.log(`Remove car with ID: ${r}`),await i.remove(r),await m.render(1,e.limit)}},d={idForm:`update_car_form`,localStorageKey:`async_race__update_data`,idNameInput:`update_car__name_input`,idColorInput:`update_car__color_input`,render(){let e=d.getUpdateData();return`
      <form id="${d.idForm}">
        <label for="${d.idNameInput}">Car name:</label>
        <input id="${d.idNameInput}" type="text" name="name" value="${e.name}">
        <label for="${d.idColorInput}">Car color:</label>
        <input id="${d.idColorInput}" type="color" name="color" value="${e.color}">
        <button class="btn btn-success">Update</button>
        <input type="hidden" name="id" value="${e.id}">
      </form>
    `},init(){let e=document.querySelector(`#${d.idForm}`);if(!e){console.error(`Node not found: #${d.idForm}`);return}e.addEventListener(`submit`,d.onSubmit);let t=document.querySelector(`#${d.idNameInput}`);if(!t){console.error(`Node not found: #${d.idNameInput}`);return}t.addEventListener(`input`,function(){d.setName(this.value)});let n=document.querySelector(`#${d.idColorInput}`);if(!n){console.error(`Node not found: #${d.idColorInput}`);return}n.addEventListener(`input`,function(){d.setColor(this.value)})},async onSubmit(t){t.preventDefault();let n=t.target,r=new FormData(n),a={name:r.get(`name`)||`Unnamed car`,color:r.get(`color`)||`#000000`};console.log(`Try to update car`,a);let o=d.getUpdateData(),s=await i.update(a,o.id);console.log(`Updated car`,s),await m.render(1,e.limit)},getUpdateData(){let e=localStorage.getItem(d.localStorageKey),t={id:0,name:``,color:``};if(e)try{let n=JSON.parse(e);typeof n==`object`&&n&&`id`in n&&typeof n.id==`number`&&(t.id=n.id),typeof n==`object`&&n&&`name`in n&&typeof n.name==`string`&&(t.name=n.name),typeof n==`object`&&n&&`color`in n&&typeof n.color==`string`&&(t.color=n.color)}catch(e){console.error(e)}return localStorage.setItem(d.localStorageKey,JSON.stringify(t)),t},setId(e){let t=d.getUpdateData();t.id=e,localStorage.setItem(d.localStorageKey,JSON.stringify(t))},setName(e){let t=d.getUpdateData();t.name=e,localStorage.setItem(d.localStorageKey,JSON.stringify(t))},setColor(e){let t=d.getUpdateData();t.color=e,localStorage.setItem(d.localStorageKey,JSON.stringify(t))}},f={idForm:`select_car_form`,render(e){return`
      <button class="btn btn-warning" data-select-car-id="${e}">Select</button>
    `},init(e){let t=`button[data-select-car-id="${CSS.escape(String(e))}"]`,n=document.querySelector(t);if(!n){console.error(`Node not found: ${t}`);return}n.addEventListener(`click`,f.onClick)},async onClick(t){let n=t.target,r=Number(n.dataset.selectCarId)||0;d.setId(r);let a=await i.getById(r);d.setName(a.name),d.setColor(a.color),await m.render(1,e.limit)}},p={idGarageContent:`garage_content`,async render(e,t){let n=`#${p.idGarageContent}`,r=document.querySelector(n);if(!r){console.error(`Node is not found: ${n}`);return}r.innerHTML=`Loading...`;let{CARS:o,TOTAL_COUNT:c}=await i.getPagination(e,t);r.innerHTML=`
      <div>Garage (${c})</div>
      <div>Page #${e}</div>
      ${o.map(e=>`
        <div>
      ...
      `).join(``)}
    `,o.length===0&&(r.innerHTML=`No cars`),a.init(),d.init();for(let e of o)f.init(e.id),u.init(e.id);document.querySelector(`#generate_cars`)?.addEventListener(`click`,i.generageRandom100Cars),await l.render(e,t,c)}},m={async render(e,t){let n=`#${g.idContent}`,r=document.querySelector(n);if(!r){console.log(`Node is not found: ${n}`);return}try{r.innerHTML=`
        ${a.render()}
        ${d.render()}
        <div>
          <button
      ...
      `,document.querySelector(`#garage_render`)?.addEventListener(`click`,async()=>m.render(1,e.limit)),document.querySelector(`#winner_render`)?.addEventListener(`click`,h.render),await m.render(1,e.limit)}catch(e){n.innerHTML=`
        <div style='color: red;'>
          ${e}
        </div>
